...
tf.app.flags.DEFINE_string("ps_hosts", "localhost:2222,localhost:2223", "ps hosts")
tf.app.flags.DEFINE_string("worker_hosts", "localhost:2224,localhost:2225", "worker hosts")
